...
ALTER TABLE
    user_info ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Read All User Info" ON user_info FOR
SELECT
    USING (true);
...
values
    (
        ...
        'metus arcu adipiscing molestie hendrerit at vulputate vitae nisl aenean lectus pellentesque eget',
        113.8,
        'items_for_sale',
        'M5B2K3',
        '2024-03-03 16:35:29',
...
values
    (
        ...
        'vestibulum rutrum rutrum neque aenean auctor gravida sem praesent id massa',
        439.58,
        'items_for_sale',
        'M5B2K3',
        '2023-11-03 06:03:27',
...
values
    (
        'Repurposed industrial pendant light',
        'vestibulum eget vulputate ut ultrices vel augue vestibulum ante ipsum primis in',
        699.85,
        'items_for_sale',
        'M5B2K3',
        '2023-05-19 22:57:44',
...
values
    (
        'Rustic farmhouse sign',
        'rhoncus aliquet pulvinar sed nisl nunc rhoncus dui vel sem sed',
        718.22,
        'academic_services',
        'M5B2K3',
        '2023-10-13 04:00:01',
...
values
    (
        'Upcycled denim tote bag',
        'aenean auctor gravida sem praesent id massa id nisl venenatis',
        695.8,
        'items_wanted',
        'M5B2K3',
        '2023-11-06 15:28:10',
...
insert into
    public .images (link, alt_text, post_id)
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/ec82ea34-0100-4bf7-a637-015fbbf50c94/828993018656_cat2.jpg',
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/121476_otter2.jpg',
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/320334_otter.jpg',
        'tincidunt eu',
        3
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/704056b9-c45f-4731-a150-a43d99d9164e/151436_pngtree-kawaii-little-kitten-picture-image_2777072.jpg',
        'nulla elit',
        4
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/ec82ea34-0100-4bf7-a637-015fbbf50c94/682113145606_cat1.jpg',
        'eget rutrum at',
        6
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/ec82ea34-0100-4bf7-a637-015fbbf50c94/606328911924_cat3.jpg',
        'in faucibus',
        8
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/278168_otter4.jpg',
        'neque libero',
        11
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/215991272_hat.png',
        'vestibulum ante',
        13
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/173670_silly_monkey.jpg',
        'vivamus vestibulum',
        14
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/137927_otter3.jpg',
        'sapien arcu sed',
        15
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/101010_kitten-cat.gif',
        'fusce posuere felis',
        16
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/415201_Screen%20Shot%202024-02-07%20at%201.53.41%20PM.png',
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/652630e9-a92f-4c3e-ae7a-b74a6fef939d/334438_monke.png',
        'erat eros viverra',
        6
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/ec82ea34-0100-4bf7-a637-015fbbf50c94/606328911924_cat3.jpg',
        'pulvinar lobortis est phasellus',
        46
    );
...
values
    (
        'https://wduwhfiooshcbzbgenyy.supabase.co/storage/v1/object/public/images/uploads/ec82ea34-0100-4bf7-a637-015fbbf50c94/828993018656_cat2.jpg',
        'venenatis tristique fusce congue',
        47
    );
